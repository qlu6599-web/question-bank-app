  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "options": [],
        "answer": "（1）R最高符合2NF。由于R的主键是单一属性工号，因此必然是2NF。又由于工号->部门号，且部门号->部门名，因此工号->部门名是一个传递函数依赖，则R不符合3NF。（阐述理由部分可由学生自由发挥）\n（2）\nR1(工号，姓名，性别，部门号)，其中工号为主键，部门号为外键\nR2（部门号，部门名，部门负责人），其中部门号为主键",
      ...
      },
      {
        ...
        "options": [],
        "answer": "（1）R最高符合1NF。由于R的主键是（学号，图书号，借阅时间）。由于（学号，图书号，借阅时间）->姓名，并且学号->姓名，因此R中存在主键到非主属性的部分函数依赖，所以R不符合2NF。（阐述理由部分可由学生自由发挥）\n（2） R1（学号，姓名，性别），其中学号为主键\nR2（图书号，图书名，出版社），其中图书号为主键\nR3（学号，图书号，借阅时间），其中（学号，图书号，借阅时间）为联合主键，且存在两个外键：学号，图书号",
      ...
      },
      {
        ...
        "options": [],
        "answer": "（1）R最高符合1NF。由于R的主键是（运动员编号，项目号）。由于（运动员编号，项目号）->姓名，并且运动员编号->姓名，因此R中存在主键到非主属性的部分函数依赖，所以R不符合2NF。（阐述理由部分可由学生自由发挥）\n（2）\nR1(运动员编号，姓名，性别)，其中运动员编号为主键\nR2（项目号，项目名），其中项目号为主键\nR3（运动员编号，项目号，比赛成绩），其中（运动员编号，项目号）为联合主键，且存在两个外键：运动员编号，项目号",
      ...
      },
      {
        ...
        "options": [],
        "answer": "（1）R最高符合2NF。由于R的主键是单一属性学号，因此必然是2NF。又由于学号->系号，且系号->系名，因此学号->系名是一个传递函数依赖，则R不符合3NF。（阐述理由部分可由学生自由发挥）\n（2）\nR1(学号，姓名，性别，系号)，其中学号为主键，系号为外键\nR2（系号，系名，系主任），其中系号为主键",
      ...
      },
      {
        ...
        "options": [],
        "answer": "（1）R最高符合1NF。由于R的主键是（学号，课程号）。由于（学号，课程号）->姓名，并且学号->姓名，因此R中存在主键到非主属性的部分函数依赖，所以R不符合2NF。（阐述理由部分可由学生自由发挥）\n（2）R1（学号，姓名，性别），其中学号为主键\nR2（课程号，课程名），其中课程号为主键\nR3（学号，课程号，成绩），其中（学号，课程号）为联合主键，且存在两个外键：学号和课程号",
      ...
      },
      {
        ...
        "options": [],
        "answer": "create database book_lib",
      ...
      },
      {
        ...
        "options": [],
        "answer": "inset into student values(‘1001’, ‘王刚’, 20, ‘男’, ‘软件工程’)",
      ...
      },
      {
        ...
        "options": [],
        "answer": "delete from sb where sid=‘1001’",
      ...
      },
      {
        ...
        "options": [],
        "answer": "select sname,age,sex,major\nfrom student\nwhere sname like '李%';",
      ...
      },
      {
        ...
        "options": [],
        "answer": "student、book、sb三张表做自然连接，继而基于条件age>=30进行选择操作，最后在bname列做投影操作。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "create database teachingdb",
      ...
      },
      {
        ...
        "options": [],
        "answer": "insert into course values（‘C001’，’数据库’）",
      ...
      },
      {
        ...
        "options": [],
        "answer": "delete from tc where tid=’1001’",
      ...
      },
      {
        ...
        "options": [],
        "answer": "teacher，course和tc三张表做自然连接，继而基于title=’教授’条件做选择，最后在cname列做投影。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "create database booksales",
      ...
      },
      {
        ...
        "options": [],
        "answer": "insert into customer( cid, cname) values (‘C001’, ‘王刚’)",
      ...
      },
      {
        ...
        "options": [],
        "answer": "delete from cb where cid=’1001’",
      ...
      },
      {
        ...
        "options": [],
        "answer": "select bname,author,price\nfrom book\nwhere price between 50 and 100;",
      ...
      },
      {
        ...
        "options": [],
        "answer": "select cid,shoppingdate\nfrom cb\nwhere bid='b001'\norder by shoppingdate asc;",
      ...
      },
      {
        ...
        "options": [],
        "answer": "select cname,tel,address\nfrom customer\nwhere address like '%杨浦%';",
      ...
      },
      {
        ...
        "options": [],
        "answer": "customer，book和cb三张表做自然连接，继而基于bname=’数据库应用技术’条件做选择，最后在cname列做投影。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "delete from sc where cid=’1001’",
      ...
      },
      {
        ...
        "options": [],
        "answer": "student，course和sc三张表做自然连接，继而基于major=’机械电子’条件做选择，最后在cname列做投影。",
    ...
    "questions": [
      {
        "id": "ds-1",
        "type": "single",
        "question": "在 DIKW 金字塔模型中，能够回答 “who-what-when-where” 等模式问题，并被视为解释\n事物之间相互关系的是哪一层？",
        "options": [
          "数据",
          "信息",
          "知识",
      ...
      },
      {
        "id": "ds-4",
        "type": "single",
        "question": "数据科学的发展历程中，哪一位学者在 2001 年提出了大数据的 “3V” 模型？",
        "options": [
          "约翰 · 图基",
          "埃德加 · 科德",
          "道格 · 莱尼",
      ...
      },
      {
        "id": "ds-5",
        "type": "single",
        "question": "在数据科学生命周期中，通常最为耗时和繁琐，大约占据 75% 工作量的阶段是？",
        "options": [
          "业务理解",
          "数据获取与收集",
          "数据清洗与预处理",
      ...
      },
      {
        "id": "ds-6",
        "type": "single",
        "question": "某研究机构收集了 “2010 年至 2024 年全国各省每年的 GDP 数据 ” ，这种结合了多个观测单\n元在多个时间点进行跟踪采集的数据属于？",
        "options": [
          "横截面数据",
          "时间序列数据 No. 2 / 65",
          "面板数据",
      ...
      },
      {
        "id": "ds-8",
        "type": "single",
        "question": "早在 1970 年，首次提出关系模型概念，从而奠定了关系数据库理论基础的 IBM 研究员\n是？",
        "options": [
          "Bill Inmon",
          "Ralph Kimball",
          "Edgar Codd",
      ...
      },
      {
        "id": "ds-9",
        "type": "single",
        "question": "关系数据库遵循 ACID 原则，其中 “ 事务一旦提交后，它所做的修改将会永久保存在数据\n库上，即使出现意外系统故障或断电情况也不会丢失 ” 描述的是哪一特性？",
        "options": [
          "原子性",
          "一致性",
          "隔离性 No. 3 / 65",
      ...
      },
      {
        "id": "ds-10",
        "type": "single",
        "question": "在 SQL 语言中，若希望查询结果中去除重复的值，应该使用以下哪个关键字？",
        "options": [
          "ORDER BY",
          "DISTINCT",
          "UNIQUE",
      ...
      },
      {
        "id": "ds-14",
        "type": "single",
        "question": "下列哪种 NoSQL 数据库类型最适合用于 “ 查找朋友的朋友 ” 或 “ 识别欺诈团伙 ” 等高度互联\n数据的场景？",
        "options": [
          "键值存储数据库",
          "文档数据库",
          "列式数据库",
      ...
      },
      {
        "id": "ds-17",
        "type": "single",
        "question": "在数据预处理的数据标准化环节中，若希望转换后的数据分布均值为 0 、标准差为 1 ，\n且转换结果不易受异常值干扰，应选择下列哪种方法？",
        "options": [
          "最大最小值标准化",
          "Z-score 标准化",
          "独热编码",
      ...
      },
      {
        "id": "ds-22",
        "type": "single",
        "question": "在 Tableau 中，若希望将 “ 公司 ” 和 “ 小型企业 ” 两个字段合并，以便与 “ 消费者 ” 进行对比\n分析，应使用以下哪项功能？",
        "options": [
          "聚类",
          "分组",
          "筛选器",
      ...
      },
      {
        "id": "ds-23",
        "type": "single",
        "question": "关于 Tableau 中的 “ 故事 ” 功能，下列说法正确的是？",
        "options": [
      ...
      },
      {
        "id": "ds-24",
        "type": "single",
        "question": "在 Tableau 中，若要在散点图中根据数据特征自动将样本划分为不同的群组，应点击\n“ 分析 ” 菜单下的哪个选项？",
        "options": [
          "趋势线",
          "参考线",
          "预测",
      ...
      },
      {
        "id": "ds-26",
        "type": "single",
        "question": "在统计分析中，若分析师利用样本数据得出 “ 有 95% 的信心认为销售部员工的平均血压\n高于人力资源部 ” 的结论，这属于哪种统计分析类型？",
        "options": [
          "描述性统计",
          "探索性统计",
          "推断性统计",
      ...
      },
      {
        "id": "ds-27",
        "type": "single",
        "question": "在数据科学的发展历程中，哪一事件标志着大数据成为驱动人工智能取得突破的关键\n性因素，并宣告了大数据与 AI 时代的正式到来？",
        "options": [
          "2001 年道格 · 莱尼发布研究报告，提出 “3V” 模型",
          "2003-2006 年 Google 发表关于 GFS 、 MapReduce 和 BigTable 的开创性论文",
          "2012 年维克托 · 迈尔 - 舍恩伯格出版《大数据时代》",
          "2016 年 Google 开发的 AlphaGo 以 4:1 战胜围棋世界冠军李世石"
        ],
        "answer": "D",
      ...
      },
      {
        "id": "ds-32",
        "type": "single",
        "question": "在分布式计算框架中， MapReduce 的核心思想来源于计算机科学中的哪种策略？",
        "options": [
          "动态规划",
          "贪心算法",
          "分治策略",
      ...
      },
      {
        "id": "ds-33",
        "type": "single",
        "question": "Spark 相较于 Hadoop MapReduce ，其运行速度更快的主要原因是什么？",
        "options": [
          "Spark 使用了更昂贵的硬件设备",
          "Spark 基于内存计算，并使用了 DAG 执行引擎",
          "Spark 仅支持 Java 语言，执行效率更高",
          "Spark 放弃了容错机制以换取速度"
        ],
        "answer": "B",
      ...
      },
      {
        "id": "ds-34",
        "type": "single",
        "question": "若某电商平台需要构建一个实时推荐系统，能够在用户浏览行为发生的 500 毫秒内完成\n个性化推荐，最适合采用哪种类型的计算框架？",
        "options": [
          "批处理框架",
          "流式计算框架",
          "增量计算框架",
      ...
      },
      {
        ...
        "options": [
          "单个公共安防摄像头每小时产生的数据量为 100GB",
          "北京地铁每日数据增量突破 1TB",
          "单个肿瘤患者的多期增强 CT 影像结合三维重建数据，普遍达到 60-80GB",
          "国家电网年均产生的核心运行数据达到 EB 级 No. 12 / 65"
        ],
        "answer": "C",
      ...
      },
      {
        "id": "ds-39",
        "type": "single",
        "question": "在新加坡的智慧水务管理系统中，通过部署压力传感器与泄漏监测器， 2024 年将供水\n管网泄漏率降至了多少？",
        "options": [
          "15%",
          "4.2%",
          "12%",
      ...
      },
      {
        "id": "ds-42",
        "type": "single",
        "question": "杭州在解决 “ 潮汐车流 ” 问题时，采取了 “ 可变车道 +AI 调度 ” 模式，其主要操作方式是？",
        "options": [
          "永久性增加进城车道数量",
          "通过电子指示牌实时调整车道方向",
          "禁止私家车在高峰时段上路",
      ...
      },
      {
        "id": "ds-49",
        "type": "single",
        "question": "在智能交通应用中， ETC 系统主要利用微波专用短程通信技术实现车辆不停车收费。\nETC 系统通过安装在车辆哪里的电子标签与收费站微波天线进行通信？",
        "options": [
          "车牌上",
          "挡风玻璃上",
          "发动机舱内",
      ...
      },
      {
        "id": "ds-50",
        "type": "single",
        "question": "美国 Royal Food Import 公司利用物联网监控服务改善食品运输，其核心技术方案中，\n集装箱封锁除了具备 GPS 定位功能外，还内嵌了什么传感器以监测箱内状况？",
        "options": [
          "气味传感器",
          "辐射传感器",
          "温度和湿度传感器",
      ...
      },
      {
        "id": "ds-55",
        "type": "single",
        "question": "商务智能的概念最早由哪家机构于 1996 年正式提出？",
        "options": [
          "IBM",
          "Gartner Group",
          "Microsoft",
      ...
      },
      {
        "id": "ds-59",
        "type": "single",
        "question": "在销售领域的应用中， BI 系统可以通过分析历史销售数据、市场趋势等构建模型，实\n现精准预测。这种预测结果除了用于制定销售目标外，还能直接协同哪个系统以优化库存管\n理？",
        "options": [
          "财务管理系统",
          "人力资源系统",
          "供应链系统",
      ...
      },
      {
        "id": "ds-60",
        "type": "single",
        "question": "在营销领域， BI 系统通过整合内外部数据对客户进行细分。以下哪项属于客户细分中\n的 “ 心理维度 ” ？",
        "options": [
          "年龄、性别、收入",
          "购买频率、消费金额",
          "消费理念、品牌偏好",
      ...
      },
      {
        "id": "ds-61",
        "type": "single",
        "question": "在供应链领域的应用中， BI 系统如何帮助企业进行供应商管理？",
        "options": [
          "仅通过价格低廉程度选择供应商",
          "通过多维度评估建立供应商信用评级体系",
          "随机分配采购订单给不同供应商",
      ...
      },
      {
        "id": "ds-62",
        "type": "single",
        "question": "在金融领域的反欺诈应用中， BI 系统主要通过什么方式来识别潜在的欺诈行为？",
        "options": [
          "人工逐笔核对所有交易记录",
          "仅依赖客户的主动申报",
          "实时采集交易数据，构建异常行为识别模型",
      ...
      },
      {
        "id": "ds-63",
        "type": "single",
        "question": "商务智能的价值体现在多个方面，其中 “ 促进 PDCA 高效循环 ” 主要属于哪个层面的价\n值？",
        "options": [
          "支撑管理决策",
          "提升管理水平 No. 20 / 65",
          "提高业务运营效率",
      ...
      },
      {
        "id": "ds-64",
        "type": "single",
        "question": "根据 2025 年国家卫健委发布的《卫生健康行业数据分类分级指南（试行）》（征求意\n见稿），医疗大数据被定义为具有 “ 三性 ” 的数据集合。以下哪项不属于这 “ 三性 ” ？",
        "options": [
          "场景关联性",
          "隐私敏感性",
          "价值潜在性",
      ...
      },
      {
        "id": "ds-69",
        "type": "single",
        "question": "关于 BergHealth 公司在药物研发中的做法，以下描述正确的是？",
        "options": [
          "完全依赖传统的试错法进行药物筛选",
          "利用大数据平台从大量样本数据中创建病人 “ 图谱 ” ，反向推导治疗方案",
          "仅使用基因组学数据，忽略蛋白质组学和代谢组学",
          "研发一款新药的周期通常需要 10 年以上 No. 22 / 65"
        ],
        "answer": "B",
      ...
      },
      {
        ...
        "options": [
          ...
          "限制用户只能看到最近 30 天发布的新内容 No. 23 / 65"
        ],
        "answer": "C",
      ...
      },
      {
        "id": "ds-76",
        "type": "single",
        "question": "Target 百货公司通过分析消费数据构建 “ 怀孕预测指数 ” ，其主要目的是为了解决什么问\n题？",
        "options": [
          "优化物流配送路线",
      ...
      },
      {
        "id": "ds-83",
        "type": "single",
        "question": "Netflix 决定投资制作《纸牌屋》的主要依据是？",
        "options": [
          "导演和演员的知名度高",
          "竞争对手 HBO 拒绝了该剧本",
      ...
      },
      {
        "id": "ds-85",
        "type": "single",
        "question": "爱奇艺发现 “ 连续 7 天观看超 2 小时 ” 的用户付费转化率极高，针对这类用户推送定向优\n惠。这属于哪种商业化变现策略？",
        "options": [
          "广告运营",
          "衍生品销售",
          "会员运营",
      ...
      },
      {
        "id": "ds-86",
        "type": "single",
        "question": "在餐饮 O2O 模式中，实现 “ 数据闭环 ” 的关键在于？",
        "options": [
          "只关注线上引流，不关注线下消费",
      ...
      },
      {
        "id": "ds-90",
        "type": "single",
        "question": "2013 年曝光的 “ 棱镜门 ” 事件中，美国国家安全局主要通过什么方式实施全球监听？",
        "options": [
          "仅通过派遣特工进行线下窃听",
          "仅监听美国本土公民的电话记录",
      ...
      },
      {
        "id": "ds-91",
        "type": "single",
        "question": "Facebook 数据滥用事件（剑桥分析事件）的核心矛盾在于？",
        "options": [
          "黑客通过技术手段攻破了 Facebook 的防火墙",
      ...
      },
      {
        "id": "ds-92",
        "type": "single",
        "question": "在 12306 数据泄露事件中，黑客使用的攻击手段 “ 撞库 ” 是指？",
        "options": [
          "使用暴力破解软件尝试所有可能的密码组合",
          "利用此前其他网站泄露的 “ 用户名 + 密码 ” 组合，批量尝试登录目标平台 No. 29 / 65",
          "物理破坏服务器硬盘以窃取数据",
          "伪造钓鱼网站诱导用户输入密码"
        ],
        "answer": "B",
      ...
      },
      {
        ...
        "options": [
          ...
          "用户一旦同意，企业即可将数据用于任何商业用途 No. 30 / 65"
        ],
        "answer": "C",
      ...
      },
      {
        "id": "ds-102",
        "type": "judge",
        "question": "在数据世界中，结构化数据占据了绝大多数，约占总数据量的 80% 以上。\n正确答案：错误\n答案解析：非结构化数据约占总数据量的 80% 以上。\n章节：第一章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-104",
        "type": "judge",
        "question": "JSON 数据格式使用键值对和数组来组织数据，是一种典型的半结构化数据。\n正确答案：正确\n答案解析： JSON 是当前最流行的 Web 数据交换格式，属于常见的半结构化数据。\n章节：第一章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-107",
        "type": "judge",
        "question": "1970 年， IBM 的计算机科学家 Edgar Codd 提出了关系模型，奠定了现代关系型数据库\n的理论基础。\n正确答案：正确\n答案解析： Edgar Codd 在 1970 年发表论文提出了关系模型，奠定了关系型数据库的理论基\n础。\n章节：第一章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-109",
        "type": "judge",
        "question": "NoSQL 数据库的出现是为了完全替代传统的关系型数据库，因为关系型数据库已经无法\n适应现代应用需求。\nNo. 33 / 65\n正确答案：错误\n答案解析： NoSQL 数据库与关系数据库是互补关系，而非替代关系。它们各自有不可替代\n的优势。\n章节：第二章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-110",
        "type": "judge",
        "question": "文档数据库通常采用 JSON 或 XML 格式存储数据，其架构灵活，每个文档的结构可以不\n同。\n正确答案：正确\n答案解析：文档数据库旨在将半结构化数据存储为文档，每个 NoSQL 文档的架构是不同\n的。\n章节：第二章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-115",
        "type": "judge",
        "question": "Redis 是一种典型的键值存储数据库，它通常将重要数据存储在内存中以实现低延迟访\n问。\nNo. 34 / 65\n正确答案：正确\n答案解析：键值存储数据库针对性能优化，将数据存储在内存中。\n章节：第二章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-120",
        "type": "judge",
        "question": "Nathan Yau 认为，将数据属性映射为视觉感知层面的位置、颜色、形状等，能帮助人\n类大脑更高效地识别潜藏的模式、趋势和异常。\n正确答案：正确\n答案解析： Nathan Yau 在《数据可视化指南》中表达：把数字置于视觉空间中，大脑更容\n易发现潜藏模式。\n章节：第四章\nNo. 35 / 65",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-121",
        "type": "judge",
        "question": "在 Tableau 中，若要展示与地理位置相关的数据，必须先手动输入经纬度数据才能生成\n地图。\n正确答案：错误\n答案解析：无需强制手动输入经纬度（除非数据源无法识别）。\n章节：第四章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-122",
        "type": "judge",
        "question": "在 Tableau 中创建仪表板时，如果希望某个筛选器的操作能同时影响仪表板上的所有图\n表，需要在筛选器设置中选择 “ 应用于工作表 ”-“ 使用此数据源的所有项 ” 。\n正确答案：正确\n答案解析：利用 Tableau 进行数据可视化：在筛选框的下拉菜单中选择 “ 应用于工作表 ”-“ 使\n用此数据源的所有项 ” ，则可以在筛选时同步更改相关的其他图表。\n章节：第四章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-123",
        "type": "judge",
        "question": "Tableau 绘制的图表数据无法直接导出，必须通过截图方式保存到 Excel 中。\n正确答案：错误\n答案解析：复制图表中的数据，可直接粘贴至 Excel 表格中。\n章节：第四章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-124",
        "type": "judge",
        "question": "在 Tableau 中，可以通过将 “ 利润 ” 字段拖入 “ 标记 ” 卡的 “ 颜色 ” 属性，并设置渐变颜色，\n来制作突出显示表。\n正确答案：正确\n答案解析： “ 突出显示表 ” ：操作步骤是将利润拖入 “ 标记 ”-“ 颜色 ” ，并编辑颜色属性选择渐变\n颜色。\n章节：第四章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-128",
        "type": "judge",
        "question": "根据 “ 大数据摩尔定律 ” ，全球数据总量长期保持约每年 50% 的增长率，意味着数据量每\n五年翻一番。\n正确答案：错误\n答案解析： “ 大数据摩尔定律 ” 是指数据总量每两年翻一番，而不是每五年。\n章节：第六章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-132",
        "type": "judge",
        "question": "MapReduce 计算框架采用两级处理模型，其中 Reduce 阶段负责自顶向下将大型任务\n拆分为细粒度子任务。\n正确答案：错误\n答案解析： Map 阶段负责分解映射（拆分任务），而 Reduce 阶段负责归约聚合（合并结\n果）。\n章节：第六章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-133",
        "type": "judge",
        "question": "Storm 是一个面向批处理的架构，其首要优化指标是提高系统的吞吐量。\nNo. 37 / 65\n正确答案：错误\n答案解析： Storm 采用事件驱动的流处理模型，以低延迟响应为首要优化指标；而\nMapReduce 才是面向批处理且追求高吞吐量。\n章节：第六章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-134",
        "type": "judge",
        "question": "Pregel 是由 Google 提出的分布式图计算模型，专门用于处理大规模图结构数据，支持\nPageRank 等算法。\n正确答案：正确\n答案解析：文档 “ 处理框架 Pregel” 。\n章节：第六章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-135",
        "type": "judge",
        "question": "Tableau 是一款需要编写复杂代码才能创建可视化图表的商业智能工具，因此使用门槛\n较高。\n正确答案：错误\n答案解析： Tableau 通过直观的拖放式操作界面，用户无需编程即可快速构建可视化图表，\n理念是 “ 人人可用的数据分析 ” 。\n章节：第六章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-138",
        "type": "judge",
        "question": "现有的分布式数据库和 Hadoop 等数据管理方式，目前已能完全满足智慧城市应用对于\n海量数据查询与管理的实时性和灵活性要求。\n正确答案：错误\n答案解析：分布式数据库、 Hadoop 等现有方式 “ 尚无法完全满足 ” 智慧城市应用的实时性和\n灵活性要求。\n章节：第七章\nNo. 38 / 65",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-140",
        "type": "judge",
        "question": "新加坡的 “ 智慧国 2.0” 战略升级方案于 2014 年正式推出。\n正确答案：错误\n答案解析： 2014 年发布的是全球首个 “ 智慧国 ” 蓝图，而 “ 智慧国 2.0” 战略升级方案是在 2024\n年正式推出的。\n章节：第七章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-150",
        "type": "judge",
        "question": "Royal Food Import 公司的食品监控方案中，集装箱封锁一旦上锁，就会连续发射唯一\n的 ID 码，且无法设置为不激活状态。\n正确答案：错误\n答案解析：封锁可设置在海上或非信号范围内不激活。\n章节：第八章\nNo. 40 / 65",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-152",
        "type": "judge",
        "question": "上海地铁的刷脸进站技术依托蚂蚁金服的人脸识别算法，在实测中识别率超过 95% ，\n乘客无需停留即可通过。\n正确答案：正确\n答案解析：依托蚂蚁金服的人脸识别算法，在 1:3000 身份识别场景下实测识别率超 95% ，\n乘客无需停留即可快速通过闸机。\n章节：第八章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-157",
        "type": "judge",
        "question": "目前企业中 80% 以上的数据属于非结构化数据，且这类数据正以较快的速度增长。\n正确答案：正确\n答案解析：目前企业中 80% 以上的数据属于非结构化数据，且正以每年 55%~65% 的速度快\n速增长。\n章节：第九章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-159",
        "type": "judge",
        "question": "在销售业绩分析中， BI 系统只能按时间维度分析业绩波动，无法按区域或产品维度进\n行分析。\n正确答案：错误\n答案解析：销售业绩分析与监控维度包括时间维度、区域维度、产品维度以及销售人员维\n度。\n章节：第九章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-161",
        "type": "judge",
        "question": "在财务领域， BI 系统可以帮助企业进行成本分析，识别成本管控的关键环节，例如发\n现某产品的原材料成本占比过高。\n正确答案：正确\n答案解析： BI 系统通过精细化拆分与分析成本数据，可以识别成本管控的关键环节。\n章节：第九章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-162",
        "type": "judge",
        "question": "客户关系管理中的 360 度客户画像构建仅依赖于企业内部的客户数据，不需要结合外部\n数据。\n正确答案：错误\n答案解析：构建 360 度客户画像需要整合企业内部各系统的数据，同时结合外部数据。\n章节：第九章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-163",
        "type": "judge",
        "question": "在金融领域， BI 系统可以通过自然语言处理技术解析财经新闻和研报观点，量化舆情\n对资产价格的影响，从而辅助投资决策。\nNo. 42 / 65\n正确答案：正确\n答案解析： BI 系统通过自然语言处理技术解析财经新闻、研报观点，量化舆情对资产价格\n的影响。\n章节：第九章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-166",
        "type": "judge",
        "question": "随着测序技术的突破，人类基因组测序成本已经从 2000 年的约 1 亿美元大幅降至如今\n的 1000 美元左右。\n正确答案：正确\n答案解析：随着测序技术的突破，人类基因组测序成本从 2000 年的约 1 亿美元大幅降至如\n今的 1000 美元左右。\n章节：第十章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-168",
        "type": "judge",
        "question": "IBM 的沃森机器人医生可以依据患者的临床、病理及基因等特征，完全替代人类医生\n进行独立诊疗。\n正确答案：错误\n答案解析：沃森机器人医生是为医生提出规范化临床路径及个体化治疗建议，协助医生做\n出最佳诊断。\n章节：第十章\nNo. 43 / 65",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-183",
        "type": "judge",
        "question": "Disney+ 的 “ 内容潜力评分系统 ” 在采购版权时，主要依赖采购人员对 IP 的主观喜爱程度\n进行打分。\n正确答案：错误\n答案解析：该系统进行 100 余项指标评估，包括 IP 过往数据、主创口碑、用户匹配度等量化\n数据，而非主观喜爱。\n章节：第十一章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-185",
        "type": "judge",
        "question": "在餐饮 O2O 模式中，线上评价数据可以帮助线下门店定位服务痛点并进行改进。\n正确答案：正确\n答案解析：大数据分析线上评价可定位门店问题（如服务响应慢），从而指导线下改进。\n章节：第十一章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-188",
        "type": "judge",
        "question": "NoSQL 数据库由于发展时间较短，安全防护机制相对不完善，曾多次发生被攻击导致\n泄密事件。\n正确答案：正确\n答案解析： MongoDB 作为典型的 NoSQL 数据库，因发展时间短、安全防护机制不完善，\n曾多次发生被黑客攻击导致数据库泄密的事件。\n章节：第十二章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-191",
        "type": "judge",
        "question": "手机 APP 在安装时要求读取通讯录权限，即使该功能与 APP 核心业务无关（如手电筒\nAPP ），也符合数据采集的 “ 必要原则 ” 。\n正确答案：错误\n答案解析：像手电筒这类功能单一的 APP 要求读取通讯录，违背了 “ 必要原则 ” 。\n章节：第十二章\nNo. 47 / 65",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-192",
        "type": "judge",
        "question": "在公共场所使用免费 WiFi 进行支付、转账等操作是非常安全的，因为商家会保护用户\n信息。\n正确答案：错误\n答案解析：大数据安全的典型案例，免费 WiFi 存在黑客搭建陷阱窃取信息的风险，个人应\n避免连接无密码的公共 WiFi 进行支付转账。\n章节：第十二章",
        "options": [
          "正确",
          "错误"
        ],
      ...
      },
      {
        "id": "ds-201",
        "type": "fill",
        "question": "在 DIKW 金字塔模型中，数据是信息的载体和原材料，通常是离散、混乱且缺乏明确意\n义的；而____是基于信息形成的系统性理解，包含了模式、原则和策略，可用于预测和指导行\n动。",
        "options": [],
        "answer": "知识",
        "answerText": "知识",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-203",
        "type": "fill",
        "question": "从统计学角度划分，性别（ 1 代表男， 0 代表女）属于____数据，而身高、体重属于定\n比数据。\nNo. 49 / 65",
        "options": [],
        "answer": "定类",
        "answerText": "定类",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-205",
        "type": "fill",
        "question": "按数据来源划分，企业 ERP 系统的交易数据属于内部数据，而社交媒体数据和政府公开\n数据通常属于____数据。",
        "options": [],
        "answer": "外部",
        "answerText": "外部",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-206",
        "type": "fill",
        "question": "2016 年 Google 发布的 Cloud AutoML 标志着传统机器学习的调参、特征工程等步骤被自\n动化搜索替代，降低了技术门槛，推动数据科学走向了 “____” 时代。",
        "options": [],
        "answer": "全民化",
        "answerText": "全民化",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-209",
        "type": "fill",
        "question": "SQL 语句 UPDATE table SET param=new____value WHERE condition 的作用是将满足\ncondition 条件的字段 param 更新为____。\nNo. 50 / 65",
        "options": [],
        "answer": "new_value",
      ...
      },
      {
        "id": "ds-210",
        "type": "fill",
        "question": "NoSQL 是 “____” 的缩写，指的是非关系型、分布式、不保证遵循 ACID 原则的数据存储\n系统。",
        "options": [],
        "answer": "Not only SQL",
      ...
      },
      {
        "id": "ds-212",
        "type": "fill",
        "question": "构建数据仓库的重要环节 ETL 分别代表数据的____、转换和加载。",
        "options": [],
        "answer": "抽取",
        "answerText": "抽取",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-217",
        "type": "fill",
        "question": "网络爬虫通过模拟浏览器行为发送 HTTP 请求，获取服务器返回的响应内容，再经解析\n和清洗，将非结构化或半结构化的网页数据转化为____数据。",
        "options": [],
        "answer": "结构化",
        "answerText": "结构化",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-220",
        "type": "fill",
        "question": "在数据可视化工具中， Matplotlib 、 Seaborn 属于____类别，而 Tableau 、 Power BI\n则属于 BI 商业软件类别。",
        "options": [],
        "answer": "开源库",
        "answerText": "开源库",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-222",
        "type": "fill",
        "question": "在 Tableau 中，若需要查看销售额的具体数值，可以将 “ 销售额 ” 字段拖入 “ 标记 ” 卡中的\n____，这样当鼠标悬停在图表上时就会显示具体数据。\nNo. 52 / 65",
        "options": [],
        "answer": "工具提示",
        "answerText": "工具提示",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-223",
        "type": "fill",
        "question": "Tableau 中的____功能允许用户将多个可视化图表和仪表板按逻辑顺序组织在一起，\n形成一个连贯的、交互式的演示文稿。",
        "options": [],
        "answer": "故事",
        "answerText": "故事",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-224",
        "type": "fill",
        "question": "在 Tableau 中创建分组时，若希望将除已选定组之外的所有其他类别汇总为一个组，可\n以在下拉菜单中选择____选项。",
        "options": [],
        "answer": "其他",
        "answerText": "其他",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-227",
        "type": "fill",
        "question": "高德纳公司的分析师道格 · 莱尼在 2001 年首次清晰地将大数据的挑战和特征描述为\n____模型。",
        "options": [],
        "answer": "3V",
        "answerText": "3V",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-230",
        "type": "fill",
        "question": "在分布式计算中， Google 提出了____分布式文件系统。",
        "options": [],
        "answer": "GFS",
        "answerText": "GFS",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-231",
        "type": "fill",
        "question": "Hadoop 2.0 版本进行了重大架构升级，将资源管理与任务调度功能从 MapReduce 中\n解耦，形成了独立的____层，从而支持多种计算框架运行在统一集群之上。",
        "options": [],
        "answer": "YARN",
        "answerText": "YARN",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-233",
        "type": "fill",
        "question": "Python 凭借强大的第三方库成为大数据开发的实际标准，____库用于提供基础数据\n结构（如数组）。",
        "options": [],
        "answer": "NumPy",
        "answerText": "NumPy",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-234",
        "type": "fill",
        "question": "SPSS 采用统一的 Windows 标准界面，其数据编辑器采用类似于____的二维表格结\n构。",
        "options": [],
        "answer": "Excel",
        "answerText": "Excel",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-235",
        "type": "fill",
        "question": "Power BI 是微软推出的商业智能平台，用户可通过 Power Query 组件进行直观的数据\n整理与转换，并利用内置的____语言构建复杂业务指标。",
        "options": [],
        "answer": "DAX",
        "answerText": "DAX",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-239",
        "type": "fill",
        "question": "新加坡推出的 “ 国家电子健康档案系统 ” 简称为____系统，市民通过 SingPass 登录后可\n查询过往就诊记录。",
        "options": [],
        "answer": "EHR",
        "answerText": "EHR",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-251",
        "type": "fill",
        "question": "上海交通综合信息平台应用了线圈、出租车 GPS 信息、手机信令、____系统、牌照识\n别等多种技术手段。",
        "options": [],
        "answer": "SCATS",
        "answerText": "SCATS",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-252",
        "type": "fill",
        "question": "在 Savi Networks 公司的食品监控方案中，集装箱封锁发送的数据被转发到由控制中心\n管理的____服务器，供客户通过互联网获取信息。",
        "options": [],
        "answer": "Web",
        "answerText": "Web",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-254",
        "type": "fill",
        "question": "上海地铁 18 号线二期预计于 2025 年底前实现初期运营，全线搭载基于____车地无线\n通信的全自动驾驶信号系统。",
        "options": [],
        "answer": "LTE",
        "answerText": "LTE",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-256",
        "type": "fill",
        "question": "商务智能的功能架构一般分为三个功能层级：负责管理数据（包括采集、 ETL 等）的\n____层；利用 OLAP 、数据挖掘等方法进行处理的数据分析层；以及呈现报表和可视化图表的\n数据展示层。",
        "options": [],
        "answer": "数据底层",
        "answerText": "数据底层",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-258",
        "type": "fill",
        "question": "在营销渠道效果分析中， BI 系统通过追踪各渠道的流量来源、转化路径等指标，可以\n量化各渠道的营销效果，从而提升营销投入的____。",
        "options": [],
        "answer": "产出比",
        "answerText": "产出比",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-259",
        "type": "fill",
        "question": "在供应链领域， BI 系统可以通过整合物流数据、订单数据及仓储数据，采用____算法\n来规划最优配送路线，从而降低运输成本。",
        "options": [],
        "answer": "路径优化",
        "answerText": "路径优化",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-260",
        "type": "fill",
        "question": "在财务领域， BI 系统通过构建财务风险预警模型，可以实时监控企业的____风险、流\n动性风险和信用风险等。",
        "options": [],
        "answer": "偿债",
        "answerText": "偿债",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-261",
        "type": "fill",
        "question": "在客户关系管理中，针对潜在的流失客户， BI 系统可以通过构建____模型进行识别，\n并分析流失原因，帮助企业制定挽回策略。",
        "options": [],
        "answer": "客户流失预警",
        "answerText": "客户流失预警",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-262",
        "type": "fill",
        "question": "在金融信贷业务中， BI 系统通过整合多维度数据构建机器学习驱动的风险评估模型，\n对个人信贷重点分析收入稳定性、____习惯及还款意愿。",
        "options": [],
        "answer": "消费",
        "answerText": "消费",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-263",
        "type": "fill",
        "question": "2013 年， Gartner 对 BI 概念进行了扩展，将 “Business Intelligence” 与 “Analytics” 合\n并，提出了____的新定义。",
        "options": [],
        "answer": "分析与商业智能",
        "answerText": "分析与商业智能",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-264",
        "type": "fill",
        "question": "医疗大数据的数据结构多样，其中 Word 、 PDF 文档、音视频、影像等属于____数\n据。",
        "options": [],
        "answer": "非结构化",
        "answerText": "非结构化",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-265",
        "type": "fill",
        "question": "智慧医疗通过整合各类医疗信息资源，构建了卫生领域的 6 大基础数据库，包括药品目\n录数据库、居民健康档案数据库、____数据库、检验数据库、医疗人员数据库和医疗设备数据\n库。",
        "options": [],
        "answer": "影像",
        "answerText": "影像",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-279",
        "type": "fill",
        "question": "物流领域的 “____说 ” 认为物流成本如冰山，水面下的隐性成本占比超 80% ，而大数据\n可以让这些隐性成本显形。",
        "options": [],
        "answer": "物流冰山",
        "answerText": "物流冰山",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-283",
        "type": "fill",
        "question": "Netflix 推出的剧集《____》是大数据赋能影视创作的里程碑案例，其成功证明了大数\n据可将用户需求转化为内容生产力。",
        "options": [],
        "answer": "纸牌屋",
        "answerText": "纸牌屋",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-286",
        "type": "fill",
        "question": "餐饮 O2O 模式通过线上引流、线下消费和线上____形成闭环，利用数据持续优化运\n营。",
        "options": [],
        "answer": "反馈",
        "answerText": "反馈",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-289",
        "type": "fill",
        "question": "2018 年，华住旗下连锁酒店近 5 亿条开房信息在____出售，包含用户姓名、身份证号\n等敏感数据。\nNo. 63 / 65",
        "options": [],
        "answer": "暗网",
        "answerText": "暗网",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "ds-300",
        "type": "fill",
        "question": "2019 年央视 “3·15” 晚会曝光的 “____盒子 ” ，可以在用户不知情的情况下自动捕捉手\n机 MAC 地址并关联个人信息。",
        "options": [],
        "answer": "探针",
        "answerText": "探针",
        "acceptedAnswers": [
  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        "id": "os-3",
        "type": "single",
        "question": "当 CPU 执行操作系统内核代码时，称处理器处于 ____。",
        "options": [
          "自由态",
          "用户态",
          "内核态",
      ...
      },
      {
        "id": "os-5",
        "type": "single",
        "question": "在多道程序设计环境下，操作系统分配资源以 ____ 为单位。",
        "options": [
          "程序",
          "指令",
          "进程",
      ...
      },
      {
        "id": "os-7",
        "type": "single",
        "question": "当出现 ____ 情况下，系统可能出现死锁。",
        "options": [
          "进程释放资源",
          "一个进程进入死循环",
          "多个进程竞争资源出现了循环等待",
      ...
      },
      {
        "id": "os-9",
        "type": "single",
        "question": "当一进程运行时，系统可基于某种原则强行将其撤下，把处理机分配给其他进程，这种调度方式是 ____。",
        "options": [
          "非剥夺方式",
          "剥夺方式",
          "中断方式",
      ...
      },
      {
        "id": "os-10",
        "type": "single",
        "question": "从进程提交给系统开始到进程完成为止的时间间隔称为 ____。",
        "options": [
          "进程周转时间",
          "进程运行时间",
          "进程响应时间",
      ...
      },
      {
        "id": "os-11",
        "type": "single",
        "question": "分时操作系统通常采用 ____ 策略为用户服务。",
        "options": [
          "时间片轮转",
          "先来先服务",
          "短作业优先",
      ...
      },
      {
        "id": "os-13",
        "type": "single",
        "question": "____ 是指将作业不需要或暂时不需要的部分移到外存，让出内存空间以调入其他所需数据。",
        "options": [
          "覆盖技术",
          "交换技术",
          "虚拟技术",
      ...
      },
      {
        "id": "os-15",
        "type": "single",
        "question": "若处理器有 32 位地址，则它的虚拟地址空间为 ____ 字节。",
        "options": [
          "2GB",
          "4GB",
          "100KB",
      ...
      },
      {
        "id": "os-17",
        "type": "single",
        "question": "在有随机存取需求和文件长度动态增长的情况下，宜选择 ____ 方式。",
        "options": [
          "索引分配",
          "连续分配",
          "链接分配",
      ...
      },
      {
        "id": "os-18",
        "type": "single",
        "question": "如果 I/O 设备与存储设备进行数据交换不经过CPU 来完成，这种数据交换方式是 ____。 ____",
        "options": [
          "程序查询",
          "中断方式",
          "DMA 方式",
      ...
      },
      {
        "id": "os-21",
        "type": "single",
        "question": "在分时操作系统中，当用户数为 50 时，为了保证响应时间不超过 1 秒，选取的时间片 最大值为 ____。",
        "options": [
          "10ms",
          "20ms",
          "50ms",
      ...
      },
      {
        "id": "os-22",
        "type": "single",
        "question": "在以下选项中， ____ 不属于操作系统提供给用户的可使用资源。",
        "options": [
          "中断机制",
          "处理器",
          "存储器",
      ...
      },
      {
        "id": "os-23",
        "type": "single",
        "question": "Linux 操作系统的内核使用的是 ____。",
        "options": [
          "单一内核结构",
          "层次结构",
          "虚拟机结构",
      ...
      },
      {
        "id": "os-25",
        "type": "single",
        "question": "以下进程状态转变中， ____ 转变是不可能发生的。",
        "options": [
          "运行到就绪",
          "运行到阻塞",
          "阻塞到运行",
      ...
      },
      {
        "id": "os-26",
        "type": "single",
        "question": "在操作系统中，P、V 操作是一种 ____。",
        "options": [
          "机器指令",
          "时钟中断",
          "作业控制命令",
      ...
      },
      {
        "id": "os-29",
        "type": "single",
        "question": "在分时操作系统中，进程调度经常采用 ____ 算法。",
        "options": [
          "先来先服务",
          "最高优先权",
          "时间片轮转",
      ...
      },
      {
        "id": "os-30",
        "type": "single",
        "question": "____ 优先级是在创建进程时确定的，确定之后在整个进程运行期间不再改变。",
        "options": [
          "先来先服务",
          "静态",
          "动态",
      ...
      },
      {
        "id": "os-31",
        "type": "single",
        "question": "在进程调度算法中，对短进程不利的是 ____。",
        "options": [
          "短进程优先调度算法",
          "先来先服务算法",
          "高响应比优先算法",
      ...
      },
      {
        "id": "os-32",
        "type": "single",
        "question": "以下存储管理方式中， ____ 方式可以采用静态重定位。",
        "options": [
          "固定分区",
          "分页",
          "分段",
      ...
      },
      {
        "id": "os-33",
        "type": "single",
        "question": "在固定分区分配中，每个分区的大小是 ____。",
        "options": [
          "相同",
          "随作业长度变化",
          "可以不同但预先固定",
      ...
      },
      {
        "id": "os-37",
        "type": "single",
        "question": "通常情况下，用户程序经过编译之后得到的可执行文件属于 ____。",
        "options": [
          "ASCII 文件",
          "普通文件",
          "目录文件",
      ...
      },
      {
        "id": "os-40",
        "type": "single",
        "question": "DMA 控制方式是在 ____ 之间建立一条直接数据通路。",
        "options": [
          "I/O 设备和主存",
          "两个 I/O 设备",
          "I/O 设备和 CPU",
      ...
      },
      {
        "id": "os-41",
        "type": "single",
        "question": "在操作系统中，并发性是指若干事件 ____ 发生。",
        "options": [
          "在同一时刻",
          "一定在不同时刻",
          "某一时间间隔内",
      ...
      },
      {
        "id": "os-42",
        "type": "single",
        "question": "在单 CPU、多道程序环境下的各道程序在宏观上是并行，在微观上则是 ____。",
        "options": [
          "并行",
          "并发",
          "串行",
      ...
      },
      {
        "id": "os-43",
        "type": "single",
        "question": "有关虚拟机的叙述中错误的是 ____。",
        "options": [
          "每个虚拟机都像是裸机硬件的一个拷贝",
          "在计算机上安装了 Java 虚拟机便可以执行 Java 的字节代码",
      ...
      },
      {
        "id": "os-44",
        "type": "single",
        "question": "某个运行中的进程要申请打印机，它将变为 ____。",
        "options": [
          "就绪态",
          "阻塞态",
          "创建态",
      ...
      },
      {
        "id": "os-45",
        "type": "single",
        "question": "进程状态由就绪态转换为运行态是由 ____ 引起的。",
        "options": [
          "中断事件",
          "进程状态转换",
          "进程调度",
      ...
      },
      {
        "id": "os-48",
        "type": "single",
        "question": "有 3 个作业 J1、J2、J3，其运行时间分别是 2、5、3 小时，假定它们同时到达，并在同一台处理机上以单道方式运行，则平均周转时间最小的执行序列是 ____。",
        "options": [
          "J1、J2、J3",
          "J3、J2、J1",
          "J2、J1、J3",
      ...
      },
      {
        "id": "os-49",
        "type": "single",
        "question": "一种既有利于短作业又兼顾到长作业的作业调度算法是 ____。",
        "options": [
          "先来先服务",
          "时间片轮转",
          "高响应比优先",
      ...
      },
      {
        "id": "os-50",
        "type": "single",
        "question": "____ 调度算法有利于 CPU 繁忙型的作业，而不利于 I/O 繁忙型的作业。",
        "options": [
          "时间片轮转",
          "先来先服务",
          "短作业优先",
      ...
      },
      {
        "id": "os-51",
        "type": "single",
        "question": "进程调度算法采用固定时间片轮转法，时间片过大时，就会使时间片轮转法转化为 ____ 算法。",
        "options": [
          "高响应比优先",
          "先来先服务",
          "短进程优先调度",
      ...
      },
      {
        "id": "os-57",
        "type": "single",
        "question": "由字符序列组成，文件内的信息不再划分结构，这是指 ____。",
        "options": [
          "流式文件",
          "记录式文件",
          "顺序文件",
      ...
      },
      {
        "id": "os-58",
        "type": "single",
        "question": "文件系统可以采用两级目录结构，这样可以 ____。",
        "options": [
          "缩短访问文件存储器的时间",
          "实现文件共享",
          "节省内存空间",
      ...
      },
      {
        "id": "os-60",
        "type": "single",
        "question": "与设备相关的中断处理过程是由 ____ 完成的。",
        "options": [
          "用户层 I/O",
          "设备无关的操作系统软件",
          "中断处理",
      ...
      },
      {
        "id": "os-61",
        "type": "single",
        "question": "引入多道程序技术的前提条件之一是系统具有 ____。",
        "options": [
          "多个 CPU",
          "多个终端",
          "中断功能",
      ...
      },
      {
        "id": "os-63",
        "type": "single",
        "question": "在分时系统中，时间片一定， ____，响应时间越长。",
        "options": [
          "内存越多",
          "用户数越多",
          "后备队列越少",
      ...
      },
      {
        "id": "os-64",
        "type": "single",
        "question": "在单处理机系统中实现并发技术后， ____。",
        "options": [
          "各进程在某一个时刻并行运行，CPU 与外设间并行工作",
          "各进程在某一个时间段内并行运行，CPU 与外设间串行工作",
      ...
      },
      {
        "id": "os-65",
        "type": "single",
        "question": "在操作系统中，只能在系统态下运行的指令是 ____。",
        "options": [
          "读时钟指令",
          "置时钟指令",
          "取数指令",
      ...
      },
      {
        "id": "os-66",
        "type": "single",
        "question": "发生了中断后，进入中断处理的程序属于 ____。",
        "options": [
          "用户程序",
          "可能是用户程序也可能是 OS 程序",
          "OS 程序",
      ...
      },
      {
        "id": "os-68",
        "type": "single",
        "question": "操作系统中有一组常称为特殊系统调用，它不能被系统中断，在操作系统中称为 ____。",
        "options": [
          "初始化程序",
          "原语",
          "子程序",
      ...
      },
      {
        "id": "os-70",
        "type": "single",
        "question": "进程状态由就绪状态转化到运行状态时由 ____ 引起的。",
        "options": [
          "中断事件",
          "进程状态转换",
          "进程调度",
      ...
      },
      {
        "id": "os-72",
        "type": "single",
        "question": "下面有关选择进程调度算法的准则错误的是 ____。",
        "options": [
          "尽量提高处理器利用率",
          "尽可能提高系统吞吐量",
          "适当增长进程在就绪队列中的等待时间",
      ...
      },
      {
        "id": "os-74",
        "type": "single",
        "question": "某系统中有3个并发过程都需要4个同类资源，该系统不会发生死锁的最少资源是 ____。",
        "options": [
          "9",
          "10",
          "11",
      ...
      },
      {
        "id": "os-75",
        "type": "single",
        "question": "在存储管理中采用交换与覆盖技术，其目的是 ____。",
        "options": [
          "从物理上扩充内存",
          "实现主存共享",
          "节省存储空间",
      ...
      },
      {
        "id": "os-79",
        "type": "single",
        "question": "CPU 输出数据的速度远远高于打印机的打印速度，为解决这一矛盾，可采用 ____。",
        "options": [
          "并行技术",
          "缓冲技术",
          "虚存技术",
      ...
      },
      {
        "id": "os-80",
        "type": "single",
        "question": "在关于 SPOOLing 的叙述中， ____ 描述是错误的。",
        "options": [
          "SPOOLing 系统中必须使用独占设备",
      ...
      },
      {
        "id": "os-81",
        "type": "single",
        "question": "以下 ____ 功能不是操作系统具备的主要功能。",
        "options": [
          "内存管理",
          "中断处理",
          "文字编辑",
      ...
      },
      {
        "id": "os-82",
        "type": "single",
        "question": "在单处理机系统中，处于运行态的进程 ____。",
        "options": [
          "只有一个",
          "可以有多个",
          "不能被挂起",
      ...
      },
      {
        "id": "os-84",
        "type": "single",
        "question": "设两个进程共用一个临界资源的互斥信号量 mutex，当 mutex=-1 时表示 ____。",
        "options": [
          "一个进程进入了临界区，另一个进程等待",
          "没有一个进程进入临界区",
          "两个进程都进入了临界区",
      ...
      },
      {
        "id": "os-86",
        "type": "single",
        "question": "进程控制块是描述进程状态和特性的数据结构，一个进程 ____。",
        "options": [
          "可以有多个进程控制块",
          "可以和其他进程共用一个进程控制块",
          "可以没有进程控制块",
      ...
      },
      {
        "id": "os-88",
        "type": "single",
        "question": "为了使系统中各部分资源得到均衡使用，就必须选择对资源需求不同的作业进行合理搭配。这项工作是由 ____ 完成的。",
        "options": [
          "作业调度",
          "中级调度",
          "进程调度",
      ...
      },
      {
        "id": "os-89",
        "type": "single",
        "question": "现有 3 个同时到达的作业 J1、J2 和 J3，他们的执行时间分别是 T1、T2 和 T3，且 T1 <T2<T3。系统按单道方式运行且采用短作业优先算法，则平均周转时间是 ____。",
        "options": [
          "T1+T2+T3",
          "(T1+T2+T3)/3",
          "(3T1+2T2+T3)/3",
      ...
      },
      {
        "id": "os-90",
        "type": "single",
        "question": "下列调度算法中， ____ 调度算法是绝对可以抢占的。",
        "options": [
          "先来先服务",
          "时间片轮转",
          "优先级",
      ...
      },
      {
        "id": "os-91",
        "type": "single",
        "question": "在下列选项中，属于解除死锁的方法是 ____。",
        "options": [
          "剥夺资源法",
          "资源分配图简化法",
          "银行家算法",
      ...
      },
      {
        "id": "os-93",
        "type": "single",
        "question": "如果系统的资源分配图 ____，则系统处于死锁状态。",
        "options": [
          "出现了环路",
          "没有环路",
          "每种资源只有一个，并出现了环路",
      ...
      },
      {
        "id": "os-95",
        "type": "single",
        "question": "段页式存储管理汲取了页式存储管理和段式存储管理的长处，其实现原理结合了页式和段式管理的基本思想，即 ____。",
        "options": [
      ...
      },
      {
        "id": "os-97",
        "type": "single",
        "question": "操作系统处理缺页中断时，选择一种好的调度算法对主存和辅存中的信息进行高效调度尽可能地避免 ____。",
        "options": [
          "碎片",
          "CPU 空闲",
          "多重中断",
      ...
      },
      {
        "id": "os-98",
        "type": "single",
        "question": "下列文件物理结构中，适合随机访问且易于文件扩展的是 ____。",
        "options": [
          "连续结构",
          "索引结构",
          "链式结构且磁盘块定长",
      ...
      },
      {
        "id": "os-99",
        "type": "single",
        "question": "I/O 系统硬件结构分为 4 级：1.设备控制器；2.I/O 设备；3.计算机；4.I/O 通道。按级别由高到低的顺序是 ____。",
        "options": [
          "2-4-1-3",
          "3-1-4-2",
          "2-1-4-3",
      ...
      },
      {
        "id": "os-100",
        "type": "single",
        "question": "程序员利用系统调用打开 I/O 设备时，通常使用的设备标识是 ____。",
        "options": [
          "逻辑设备名",
          "物理设备名",
          "主设备号",
      ...
      },
      {
        "id": "os-104",
        "type": "fill",
        "question": "产生死锁的 4 个必要条件是：互斥、____、循环等待和不剥夺。",
        "options": [],
        "answer": "请求与保持",
        "answerText": "请求与保持",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-105",
        "type": "fill",
        "question": "现有 3 个同时到达的作业 J1、J2、J3，执行时间 T1<T2<T3，单道短作业优先，平均周转时间是____。",
        "options": [],
        "answer": "(3T1+2T2+T3)/3",
        "answerText": "(3T1+2T2+T3)/3",
        "acceptedAnswers": [
          "(3T1+2T2+T3)/3"
        ],
      ...
      },
      {
        "id": "os-106",
        "type": "fill",
        "question": "为保证程序在主存中改变存放位置后仍能正确执行，主存空间应采用____技术。",
        "options": [],
        "answer": "重定位",
        "answerText": "重定位",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-107",
        "type": "fill",
        "question": "____是可以容纳总和超过主存容量的多个作业同时运行的一个地址空间。",
        "options": [],
        "answer": "虚拟地址空间（虚拟存储器）",
        "answerText": "虚拟地址空间（虚拟存储器）",
        "acceptedAnswers": [
          "虚拟地址空间（虚拟存储器）",
          "虚拟地址空间"
        ],
      ...
      },
      {
        "id": "os-108",
        "type": "fill",
        "question": "____是指从根目录到该文件所经历的路径中各符号名的集合。",
        "options": [],
        "answer": "绝对路径",
        "answerText": "绝对路径",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-109",
        "type": "fill",
        "question": "磁盘调度算法中， ____算法可能出现饥饿现象。",
        "options": [],
        "answer": "最短寻道时间优先",
        "answerText": "最短寻道时间优先",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-110",
        "type": "fill",
        "question": "在请求分页系统中，分页是由 ____实现的。",
        "options": [],
        "answer": "操作系统",
        "answerText": "操作系统",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-113",
        "type": "fill",
        "question": "如果进程对信号量 S 执行 V 操作，则信号量 S 的值将 ____。",
        "options": [],
        "answer": "加1",
        "answerText": "加1",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-114",
        "type": "fill",
        "question": "产生死锁的 4 个必要条件是：互斥、请求与保持、 ____和不剥夺。",
        "options": [],
        "answer": "循环等待",
        "answerText": "循环等待",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-115",
        "type": "fill",
        "question": "在可变式分区存储管理中的拼接技术可以 ____。",
        "options": [],
        "answer": "合并空闲分区",
        "answerText": "合并空闲分区",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-116",
        "type": "fill",
        "question": "使用绝对路径名访问文件是从 ____开始按目录结构访问某个文件。",
        "options": [],
        "answer": "根目录",
        "answerText": "根目录",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-117",
        "type": "fill",
        "question": "操作系统中对文件进行管理的部分叫做 ____。",
        "options": [],
        "answer": "文件系统",
        "answerText": "文件系统",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-121",
        "type": "fill",
        "question": "内存分配算法中， ____更容易产生无法利用的小碎片。",
        "options": [],
        "answer": "最佳适应算法",
        "answerText": "最佳适应算法",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-122",
        "type": "fill",
        "question": "刚被调出的页面又立即被装入所形成的频繁装入 / 调出的现象是指 ____。",
        "options": [],
        "answer": "抖动",
        "answerText": "抖动",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-124",
        "type": "fill",
        "question": "一个进程的基本状态可以从其他两种基本状态转变过来，这个基本状态一定是 ____。",
        "options": [],
        "answer": "就绪状态",
        "answerText": "就绪状态",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-125",
        "type": "fill",
        "question": "若有 4 个进程共享同一程序段，每次最多允许 3 个进程进入，则信号量的变化范围是 ____。",
        "options": [],
        "answer": "-1～3",
        "answerText": "-1～3",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-126",
        "type": "fill",
        "question": "3 个作业 J1 (2)、J2 (5)、J3 (3) 同时到达，单道运行，平均周转时间最小的执行序列是 ____。",
        "options": [],
        "answer": "J1、J3、J2",
        "answerText": "J1、J3、J2",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-128",
        "type": "fill",
        "question": "虚拟存储管理系统的基础是程序的 ____理论。",
        "options": [],
        "answer": "局部性",
        "answerText": "局部性",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-130",
        "type": "fill",
        "question": "文件控制块占 64B，盘块 1KB，一级目录， 3200 个目录项，查找一个文件平均访问 ____次磁盘。",
        "options": [],
        "answer": "100",
        "answerText": "100",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-132",
        "type": "fill",
        "question": "系统配置 2 台同类绘图仪、 3 台同类打印机，应提供 ____个设备驱动程序。",
        "options": [],
        "answer": "2",
        "answerText": "2",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-133",
        "type": "fill",
        "question": "进程从运行态到等待态可能是由于现运行进程执行了 ____操作。",
        "options": [],
        "answer": "P",
        "answerText": "P",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-134",
        "type": "fill",
        "question": "系统共有 5 个用户进程，当前 CPU 在用户态执行，最多可有 ____个用户进程处于就绪状态。",
        "options": [],
        "answer": "4",
        "answerText": "4",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-136",
        "type": "fill",
        "question": "死锁的避免是根据 ____采取措施实现的。",
        "options": [],
        "answer": "防止系统进入不安全状态",
        "answerText": "防止系统进入不安全状态",
        "acceptedAnswers": [
          "防止系统进入不安全状态"
        ],
      ...
      },
      {
        "id": "os-138",
        "type": "fill",
        "question": "在基本段式存储管理方式中， CPU 每次从内存中读取一次指令或数据需要访问内存 ____次。",
        "options": [],
        "answer": "2",
        "answerText": "2",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-140",
        "type": "fill",
        "question": "一个 FCB 占 64B，盘块大小 1KB，每个盘块中最多存放 ____个 FCB。",
        "options": [],
        "answer": "16",
        "answerText": "16",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-141",
        "type": "fill",
        "question": "磁盘 I/O 请求柱面号： 19、376、205、 134、 18、56、 193、396、29、3、 19、40，磁头起始 100 向小号码移动，采用 SCAN 算法，磁头移动 ____个磁道。",
        "options": [],
        "answer": "490",
        "answerText": "490",
        "acceptedAnswers": [
      ...
      },
      {
        "id": "os-142",
        "type": "fill",
        "question": "设备驱动程序是系统提供的一种 ____程序，专门用于在请求 I/O 的进程与设备控制器之间传输信息。",
        "options": [],
        "answer": "中断",
        "answerText": "中断",
        "acceptedAnswers": [
  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        "id": "se-58",
        "type": "single",
        "question": "根据基本的软件过程框架，“编写代码”属于下面哪个活动？",
        "options": [
          "软件需求分析",
          "软件体系结构设计",
          "软件构造",
      ...
      },
      {
        "id": "se-59",
        "type": "single",
        "question": "CMMI（能力成熟度模型集成）阶段式模型中成熟度等级中最高的是哪一级？",
        "options": [
          "优化级",
          "定量管理级",
          "已定义级",
      ...
      },
      {
        "id": "se-60",
        "type": "single",
        "question": "下面哪一项关于敏捷开发原则的陈述是不正确的？",
        "options": [
          "个体和交互重于过程和工具",
          "可运行的软件重于全面的文档",
          "客户合作重于合同的协商",
      ...
      },
      {
        "id": "se-61",
        "type": "single",
        "question": "下列哪一种UML图能够描述用况（use case）的步骤以及步骤之间的顺序？",
        "options": [
          "UML类图",
          "UML用况图",
          "UML活动图",
      ...
      },
      {
        "id": "se-63",
        "type": "single",
        "question": "下图中右侧的数据流图针对左侧的1层图中的加工3进行了精化，请问该图（右侧的图）中哪一个数据流不满足数据流模型中父图和子图平衡的要求？",
        "options": [
          "数据流c",
          "数据流g",
          "数据流e",
      ...
      },
      {
        "id": "se-64",
        "type": "single",
        "question": "以下关于软件体系结构的定义中最准确的一项是？",
        "options": [
          "一组面向对象的类以及类之间的关系",
      ...
      },
      {
        "id": "se-66",
        "type": "single",
        "question": "下列哪种UML图能够建模软件系统在运行环境中的物理结构？",
        "options": [
          "UML部署图",
          "UML类图",
          "UML顺序图",
      ...
      },
      {
        "id": "se-70",
        "type": "single",
        "question": "下列哪一种关系不会导致两个类A和B之间的耦合？",
        "options": [
          "类A中的方法m1调用类B中的方法m2",
          "类B中的方法m访问类A中的属性p",
          "类A中的方法m访问类A中的属性p",
      ...
      },
      {
        "id": "se-71",
        "type": "single",
        "question": "下列关于软件模块化设计的说法中哪一个不正确？",
        "options": [
      ...
      },
      {
        "id": "se-72",
        "type": "single",
        "question": "软件模块化设计中模块独立性可以用什么指标来衡量？",
        "options": [
          "圈复杂度",
          "内聚度与耦合度",
          "模块代码行数",
      ...
      },
      {
        "id": "se-74",
        "type": "single",
        "question": "下列哪种测试是重新执行一些已经执行过的测试，以此来保证对于代码的修改没有带来一些意外的副作用？",
        "options": [
          "恢复测试",
          "回归测试",
          "冒烟测试",
      ...
      },
      {
        "id": "se-76",
        "type": "single",
        "question": "通过修改代码消除一个已发现的错误属于哪一种软件维护类型？",
        "options": [
          "纠错性维护",
          "适应性维护",
          "改善性维护",
      ...
      },
      {
        "id": "se-78",
        "type": "single",
        "question": "下列关于“软件危机”的表现的说法中不正确的是？",
        "options": [
          "软件项目的失败率很高，经常发生延误",
          "软件项目难以维护和修改",
      ...
      },
      {
        "id": "se-79",
        "type": "single",
        "question": "根据基本的软件过程框架，“用况分析”属于下面哪个开发活动？",
        "options": [
          "软件需求分析",
          "软件体系结构设计",
          "软件构造",
      ...
      },
      {
        "id": "se-83",
        "type": "single",
        "question": "下列关于敏捷（Agile）方法的说法不正确的是？",
        "options": [
          "不需要编写任何开发文档",
      ...
      },
      {
        "id": "se-84",
        "type": "single",
        "question": "下列哪一种UML图最适合描述软件系统的外部行为？",
        "options": [
          "UML类图",
          "UML状态机图",
          "UML活动图",
      ...
      },
      {
        "id": "se-85",
        "type": "single",
        "question": "下图中右侧的数据流图针对左侧的1层图中的加工1进行了精化，请问图中哪一个数据流不满足数据流模型中父图和子图平衡的要求？",
        "options": [
          "数据流a",
          "数据流b",
          "数据流c",
      ...
      },
      {
        "id": "se-90",
        "type": "single",
        "question": "下列关于软件构造中的模块集成的说法不正确的是？",
        "options": [
          "集成过程往往伴随着集成测试",
      ...
      },
      {
        "id": "se-92",
        "type": "single",
        "question": "下列软件测试方法中哪一个不属于白盒测试方法？",
        "options": [
          "等价类划分方法",
          "条件组合覆盖方法",
          "基本路径覆盖测试",
      ...
      },
      {
        "id": "se-93",
        "type": "single",
        "question": "在软件的模块化设计中，下列哪种内聚度是最高的？",
        "options": [
          "顺序内聚",
          "逻辑内聚",
          "过程内聚",
      ...
      },
      {
        "id": "se-95",
        "type": "single",
        "question": "根据McCall软件质量模型，以下哪一项不属于软件运行方面的质量要素？",
        "options": [
          "可靠性（reliability）",
          "正确性（correctness）",
          "效率（efficiency）",
      ...
      },
      {
        "id": "se-96",
        "type": "single",
        "question": "通过修改代码消除一个所发现的错误属于哪一种软件维护类型？",
        "options": [
          "纠错性维护",
          "适应性维护",
          "改善性维护",
      ...
      },
      {
        "id": "se-98",
        "type": "single",
        "question": "下列关于“软件危机”的原因的说法中不正确的是？",
        "options": [
          "客户对软件需求的描述往往不够精确",
      ...
      },
      {
        "id": "se-103",
        "type": "single",
        "question": "敏捷（Agile）开发方法强调“可运行软件的价值高于详尽的文档”的主要原因是？",
        "options": [
          "编写文档会浪费时间",
          "能够尽早开展软件测试活动",
      ...
      },
      {
        "id": "se-104",
        "type": "single",
        "question": "下列哪一种UML图能够反映对象间消息发送的先后顺序？",
        "options": [
          "UML顺序图",
          "UML类图",
          "UML活动图",
      ...
      },
      {
        "id": "se-105",
        "type": "single",
        "question": "按照下面的数据流图，哪些加工（processing）产生了加工4所需的输入数据流？",
        "options": [
          "加工5",
          "加工1和加工2",
          "加工3和加工5",
      ...
      },
      {
        "id": "se-107",
        "type": "single",
        "question": "下面这些关于软件设计模式的说法中不正确的是？",
        "options": [
          "设计模式代表着一种软件设计经验",
      ...
      },
      {
        "id": "se-111",
        "type": "single",
        "question": "在软件的模块化设计中，下列哪种耦合度是最高的？",
        "options": [
          "数据耦合",
          "内容耦合",
          "控制耦合",
      ...
      },
      {
        "id": "se-112",
        "type": "single",
        "question": "下列哪一种测试类型能够发现模块间的接口兼容性问题？",
        "options": [
          "集成测试",
          "回归测试",
          "单元测试",
      ...
      },
      {
        "id": "se-114",
        "type": "single",
        "question": "按照软件测试的V模型，下面哪一种测试与软件需求分析相对应？",
        "options": [
          "系统测试",
          "确认测试",
          "集成测试",
      ...
      },
      {
        "id": "se-115",
        "type": "single",
        "question": "根据McCall软件质量模型，以下哪一项不属于软件修改（revision）方面的质量要素？",
        "options": [
          "效率（efficiency）（运行方面）",
      ...
      },
      {
        "id": "se-116",
        "type": "single",
        "question": "下列哪一种软件度量指标可以用于衡量软件项目的开发工作量？",
        "options": [
          "内聚度与耦合度",
          "功能点度量",
          "圈复杂度",
      ...
      },
      {
        "id": "se-118",
        "type": "single",
        "question": "下面哪一项活动不属于GB/T 8566-2007《软件生存周期过程》中的基本过程？",
        "options": [
          "软件需求分析",
          "软件体系结构设计",
          "软件详细设计",
      ...
      },
      {
        "id": "se-120",
        "type": "single",
        "question": "下面哪一种思想不属于面向对象开发方法所特有的（相对于结构化开发方法）？",
        "options": [
          "继承",
          "逐步精化",
          "类和对象",
      ...
      },
      {
        "id": "se-121",
        "type": "single",
        "question": "下列哪一种关系属于面向对象中类之间的继承关系？",
        "options": [
          "汽车与交通工具",
          "汽车与发动机",
          "汽车与驾驶员",
      ...
      },
      {
        "id": "se-122",
        "type": "single",
        "question": "下面哪一项属于“汽车”的对象属性（即每个对象所独立拥有的属性）？",
        "options": [
          "牌照号",
          "发动汽车",
          "汽车总数量",
      ...
      },
      {
        "id": "se-126",
        "type": "single",
        "question": "下列哪一种UML图可以描述一个用况中不同场景的执行路径？",
        "options": [
          "活动图",
          "用况图",
          "类图",
      ...
      },
      {
        "id": "se-129",
        "type": "single",
        "question": "在文字编辑软件中记录并提供“最近使用过的文件”的功能遵循了以下哪一项用户界面设计原则？",
        "options": [
          "减少用户的记忆负担",
          "保持界面设计的一致性",
          "允许用户交互随时被中断和撤销",
      ...
      },
      {
        "id": "se-131",
        "type": "single",
        "question": "“重新执行已经进行过测试的子集以确保对程序的修改没有产生副作用”描述的以下哪一种软件测试类型？",
        "options": [
          "集成测试",
          "单元测试",
          "回归测试",
      ...
      },
      {
        "id": "se-132",
        "type": "single",
        "question": "“确定错误的原因和准确位置并加以纠正”是下列哪一项活动的目的？",
        "options": [
          "白盒测试",
          "黑盒测试",
          "代码评审",
      ...
      },
      {
        "id": "se-134",
        "type": "single",
        "question": "修改软件使其能够在新的操作系统上运行属于哪一种软件维护类型？",
        "options": [
          "纠错性维护",
          "改善性维护",
          "适应性维护",
      ...
      },
      {
        "id": "se-139",
        "type": "single",
        "question": "下列关于敏捷软件开发的指导思想的描述中哪一项是不正确的？",
        "options": [
          "高质量的文档是传达信息最高效的一种方法",
      ...
      },
      {
        "id": "se-140",
        "type": "single",
        "question": "下列关于面向对象开发方法中的封装（encapsulation）思想的说法不正确的是？",
        "options": [
          "封装是一种信息隐藏技术",
      ...
      },
      {
        "id": "se-141",
        "type": "single",
        "question": "下列哪一种关系属于面向对象中类之间的聚集关系？",
        "options": [
          "汽车与交通工具",
          "汽车与发动机",
          "汽车与驾驶员",
      ...
      },
      {
        "id": "se-142",
        "type": "single",
        "question": "类A访问了全局变量x，调用了类B的方法m1；类B访问了全局变量y，调用了类C的方法m2；类D访问了全局变量x，调用了类C的方法m2。根据以上描述，类A和哪些类存在耦合关系？",
        "options": [
          "类B",
          "类B、类D",
          "类B、类C",
      ...
      },
      {
        "id": "se-143",
        "type": "single",
        "question": "下列关于面向对象分析中“出版物”、“图书”、“报纸”之间的关系的说法中不正确的是？",
        "options": [
          "“图书”是“出版物”的子类",
          "可以将“出版物”定义为抽象类",
      ...
      },
      {
        "id": "se-144",
        "type": "single",
        "question": "“用户学习该软件用户界面使用方法的时间少于10分钟”属于下列哪一种需求？",
        "options": [
          "易用性（usability）需求",
          "性能（performance）需求",
          "安全性（security）需求",
      ...
      },
      {
        "id": "se-146",
        "type": "single",
        "question": "下列哪种UML图可以描述一个软件系统在运行时所涉及的硬件结点以及各个结点上驻留的软件模块或部件？",
        "options": [
          "活动图",
          "顺序图",
          "构件图",
      ...
      },
      {
        "id": "se-147",
        "type": "single",
        "question": "模块化设计中模块的功能独立性可以用模块的什么指标来衡量？",
        "options": [
          "内聚度和耦合度",
          "圈复杂度",
          "代码长度",
      ...
      },
      {
        "id": "se-151",
        "type": "single",
        "question": "按照软件测试的V模型，下列哪种测试类型与软件设计相对应？",
        "options": [
          "单元测试",
          "集成测试",
          "确认测试",
      ...
      },
      {
        "id": "se-152",
        "type": "single",
        "question": "下列软件测试方法或测试准则中哪一项不属于白盒测试？",
        "options": [
          "逻辑覆盖测试",
          "基本路径覆盖测试",
          "数据流测试",
      ...
      },
      {
        "id": "se-154",
        "type": "single",
        "question": "以下哪一种活动能够在不改变软件的外部行为的情况下改善软件的设计？",
        "options": [
          "软件重构",
          "逐步求精",
          "模块化设计",
      ...
      },
      {
        "id": "se-155",
        "type": "single",
        "question": "根据McCall软件质量模型，以下哪一项属于软件运行方面的质量要素？",
        "options": [
          "可靠性（reliability）",
      ...
      },
      {
        "id": "se-160",
        "type": "multiple",
        "question": "Bug的多少通常可以用来评价软件的哪些特性？",
        "options": [
          "用户满意度",
          "可靠性",
          "软件流程的质量",
      ...
      },
      {
        "id": "se-162",
        "type": "multiple",
        "question": "针对一个Bug Fix，我们需要做Regression Test的原因是（回归测试）",
        "options": [
          "验证新的代码的确改正了缺陷。",
          "确保新的代码没有产生新的缺陷。",
          "验证新的代码有没有破坏模块的现有功能。",
      ...
      },
      {
        "id": "se-163",
        "type": "multiple",
        "question": "在VSTS中通常可以选择的分析方法有( Microsoft Visual Studio 2005 Team System )",
        "options": [
          "抽样",
          "抽象",
          "代码注入",
      ...
      },
      {
        "id": "se-164",
        "type": "multiple",
        "question": "卡内基梅隆大学用以衡量一个软件开发团队能力的模型是",
        "options": [
          "CMM（能力成熟度模型）",
          "CMU",
          "演化I（CMMI）",
      ...
      },
      {
        "id": "se-172",
        "type": "multiple",
        "question": "影响他人几种方式中，属于感性出发点的有哪些",
        "options": [
          "断言 Assertion",
          "桥梁 Bridge",
          "说服 Persuasion",
      ...
      },
      {
        "id": "se-174",
        "type": "multiple",
        "question": "软件团队模式中围绕核心人物组成的团队通常是哪几个",
        "options": [
          "主治医师模式",
          "明星模式",
          "交响乐团模式",
      ...
      },
      {
        "id": "se-191",
        "type": "multiple",
        "question": "用例（Use Case）通常包含哪些基本元素",
        "options": [
          "标题",
          "角色",
          "主要成功场景",
      ...
      },
      {
        "id": "se-193",
        "type": "multiple",
        "question": "以下哪些图可以用来表达实体和实体之间的关系",
        "options": [
          "思维导图",
          "实体关系图",
          "用况图或用例图（UCD）",
      ...
      },
      {
        "id": "se-200",
        "type": "multiple",
        "question": "对于每一个bug，会诊小组要决定采取哪些行动",
        "options": [
          "修复",
          "本来就是这样设计",
          "不修复",
      ...
      },
      {
        "id": "se-204",
        "type": "multiple",
        "question": "在采用队友评估的机制判断工作量时，通常包含哪些评价标准。",
        "options": [
          "技术等级或技术能力",
          "劳动生产力或结果",
          "对团队的贡献",
      ...
      },
      {
        "id": "se-205",
        "type": "multiple",
        "question": "在团队中解决争端可以采用哪些方法。（各有利弊）",
        "options": [
          "投票",
          "咨询",
          "独裁",
      ...
      },
      {
        ...
        "options": [],
        "answer": "软件工程就是用科学的知识和技术原理来定义，开发，维护软件的一门学科。软件工程目标：付出较低开发成本；达到要求的功能；取得较好的性能；开发的软件易于移植；只需较低的维护费用；能按时完成开发任务，及时交付使用；开发的软件可靠性高。软件工程内容：包括开发技术和开发管理两个方面。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "软件开发中常见的软件过程模型有瀑布模型、原型模型、螺旋模型、喷泉模型、统一软件过程等。其中喷泉模型、统一软件过程适用于面向对象的软件开发。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "结构化分析：简称SA，面向数据流进行数据分析的方法。采用自顶向下逐层分解的分析策略。顶层抽象地描述整个系统，底层具体地画出系统工程的每个细节。中间层则是从抽象到具体的过渡。使用数据流图，数据字典，作为描述工具，使用结构化语言，判定表，判定树描述加工逻辑。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "把一个软件需求转换为软件表示时，首先设计出软件总的体系结构。称为概要设计或结构设计。基本任务：⑴设计软件系统结构⑵进行数据结构及数据库的设计⑶编写概要设计的文档⑷评审",
      ...
      },
      {
        ...
        "question": "软件维护有哪些内容?",
        "options": [],
        "answer": "（1）校正性维护。在软件交付使用后，一些隐含的错误在某些特定的使用环境下会暴露出来。为了识别和纠正错误，修改软件性能上的缺陷，应进行确定和修改错误的过程，这个过程就称为校正性维护。（2）适应性维护。为了使应用软件适应计算机硬件、软件环境及数据环境的不断发生的变化而修改软件的过程称为适应性维护。（3）完善性维护。为增加软件功能、增强软件性能、提高软件运行效率而进行的维护活动称为完善性维护。（4）预防性维护。为了提高软件的可维护性和可靠性而对软件进行的修改称为预防性维护。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "软件测试要经过的步骤是：单元测试→集成测试→确认测试→系统测试。单元测试对源程序中每一个程序单元进行测试，检查各个模块是否正确实现规定的功能，从而发现模块在编码中或算法中的错误。该阶段涉及编码和详细设计文档。集成测试是为了检查与设计相关的软件体系结构的有关问题，也就是检查概要设计是否合理有效。确认测试主要是检查已实现的软件是否满足需求规格说明书中确定了的各种需求。系统测试是把已确认的软件与其他系统元素(如硬件、其他支持软件、数据、人工等)结合在一起进行测试。以确定软件是否可以支付使用。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "软件生存周期：一个软件从提出开发要求开始直到该软件报废为止的整个时期。包括：可行性分析和项目开发计划，需求分析，概要设计，详细设计，编码，测试，维护。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "内聚和耦合。内聚：又称为块内联系，指模块内部各成分之间相互关联的程度，以高内聚为设计目标。耦合：也称块间联系，模块之间相互联系程度的度量，联系越紧密，耦合性越强，独立性越差，以低耦合为设计目标。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "结构化分析：简称SA，面向数据流进行数据分析的方法。采用自顶向下逐层分解的分析策略。顶层抽象地描述整个系统，底层具体地画出系统工程的每个细节。中间层则是从抽象到具体的过渡。实现的步骤：⑴了解当前系统的工作流程，获得当前系统的物理模型。 ⑵抽象出当前系统的逻辑模型。 ⑶建立目标系统的逻辑模型。 ⑷作进一步补充和优化。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "需求分析：开发人员准确地理解用户的要求，进行细致的调查分析，将用户非形式的需求陈述转化为完整的需求定义，再由需求定义转换到相应的需求规格说明的过程。基本任务：⑴问题识别⑵分析与综合，导出软件的逻辑模型⑶编写文档",
      ...
      },
      {
        ...
        "options": [],
        "answer": "数据流图（DFD）一般可分为“变换流”， “事物流”两种。“变换流”：由输入﹑输出﹑变换（或称处理）三部分组成，是一顺序结构。“事物流”：它的某个加工，分离成许多发散的数据流，形成许多加工路径，并且根据输入值选择其中一个路径来执行。（这人加工称为事务处理中心）",
      ...
      },
      {
        ...
        "question": "单元测试有哪些内容?",
        "options": [],
        "answer": "单元测试主要针对模块的以下五个基本特征进行测试：(1)模块接口(2)局部数据结构(3)重要的执行路径(4)错误处理(5)边界条件",
      ...
      },
      {
        ...
        "options": [],
        "answer": "生存周期模型：描述软件开发过程中各种活动如何执行的模型。对软件开发提供强有力的支持，为开发过程中的活动提供统一的政策保证，为参与开发的人员提供帮助和指导，是软件生存周期模型化技术的基础，也是建立软件开发环境的核心。主要有：瀑布模型，增量模型，螺旋模型，喷泉模型，基于知识的模型，变换模型。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "⑴模块化：模块是软件的组成部分，是具有独立功能且可命名的一段程序，所有模块组成整体，可以满足问题的要求。⑵抽象：认识复杂现象过程所使用权的工具，只考虑事物本质的共同特性，忽略细节和其它因素。通过抽象确定组成软件的过程实体。⑶信息隐蔽：将模块实现自身功能的细节与数据”隐蔽”起来。模块间仅交换为完成系统功能所必须的信息。⑷模块独立性：每个模块只完成系统要求的独立的子功能。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "主要有三个：1、采用自顶向下、逐步求精的程序设计方法2、使用三种基本控制结构构造程序。任何程序都可以由顺序、选择、重复(循环)三种基本控制结构构造，这三种基本结构的共同点是单入口、单出口。3、主程序员组的组织形式。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "详细设计的描述方法有图形、表格和语言，其中图形常用结构化程序流程图、盒图和PAD(问题分析图)为描述工具，语言常用过程设计语言(PDL)来作为工具。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "测试的方法是为被测试模块编写驱动模块和桩模块来实现被测试单元的可运行。通过驱动模块来模拟被测试模块的上级调用模块，以上级模块调用被测模块的格式驱动被测模块，接收被测模块的测试结构并输出。桩模块则用来代替被测试模块所调用的模块。它的作用是返回被测模块所需的信息。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "软件配置管理，简称SCM(Software Configuration Management),是指一组管理整个软件生存期各阶段中变更的活动。软件配置管理技术可以使软件变更所产生的错误达到最小并最有效地提高生产率。基线：是软件生存期中各开发阶段的一个特定点，它的作用是把开发各阶段工作的划分更加明确化，使本来连续的工作在这些点上断开，以便于检查与肯定阶段成果。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "文档在软件工程中的作用如下：(1)提高软件开发过程的能见度(2)提高开发效率(3)作为开发人员阶段工作成果和结束标志(4)记录开发过程的有关信息便于使用与维护；(5)提供软件运行、维护和培训有关资料；(6)便于用户了解软件功能、性能。",
      ...
      },
      {
        ...
        "question": "说明面向对象的特征?",
        "options": [],
        "answer": "面向对象的特征是：(1)对象唯一性。每个对象都有自身唯一的标识，在对象生存期中，其标识不变，不同的对象不能有不同的标识。(2)分类性。是指将具有一致的数据结构(属性)和行为(操作)的对象抽象成类(3)继承性。是子类自动共享父类数据结构和方法的机制，这是类之间的一种关系。(4)多态性。是指相同的操作或函数过程可以作用于多种类型的对象上并获得不同的结果。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "⑴确定变换中心，逻辑输入和输出。⑵设计软件结构的顶层和第一层–变换结构。⑶设计中﹑下层模块，对第一层的模块自顶向下分解。⑷设计的优化 ：输入部分求精，每个物理输入设置专门模块，以体现系统的外部接口。其它输入模块与转换数据模块都很简单时，可将它们合并。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "复查系统规模和目标；研究当前的系统；导出新系统的高层逻辑模型；重新定义问题；导出和评价可供选择的解决方案；推荐可行的行动方案；草拟开发计划；书写文档并提交审查。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "黑盒测试和白盒测试的区别：前者基于功能，后者基于结构；黑盒测试常用方法有：边界值、等价类、因果图、错误推测法等。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "软件可维护性的定义：软件能够被理解、校正、适应及增强功能的容易程度；常见的软件维护活动有：改正型、适应型、完善型、预防型。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "CMM全称是软件能力成熟度模型；从无序到有序的进化分成5个级别，分别为：1 初始级；2 可重复级；3 已定义级；4 已管理级；5 优化级。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "数据字典是关于数据的信息的集合，对数据流程图中的各个元素做完整的定义与说明，是数据流程图的补充工具；数据字典与数据流图的关系：数据流图和数据字典共同构成系统的逻辑模型，没有数据字典数据流图就不严格，然而没有数据流图数据字典也难于发挥作用。 数据流图和对数据流图中每个元素的精确定义放在一起，才能共同构成系统的规格说明。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "软件生命周期分为三个时期八个阶段：软件定义：问题定义、可行性研究；软件开发：需求分析、概要设计、详细设计、编码、测试；软件运行：软件维护",
      ...
      },
      {
        ...
        "options": [],
        "answer": "①对象模型：表示了静态的结构化的系统数据性质，描绘了系统的静态结构，从客观世界实体的对象关系角度来描绘对象。②动态模型：该模型描述了系统的控制结构，它表示了瞬间的、行为化的系统控制性质，它关心的是系统的控制及操作的执行顺序，它从对象的事件和状态的角度出发，表现了对象的交互行为。③功能模型：表示变化的系统“功能”性质，它指明系统应该“做什么”，因此功能模型更直接的反映了用户对目标系统的要求。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "详细设计的基本任务包括：为每个模块进行详细的算法设计；为模块内的数据结构进行设计；对数据库进行物理设计；其他设计；编写详细设计说明书；评审。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "（1）黑盒测试法: 把程序看作一个黑盒子，完全不考虑程序的内部结构和处理过程。它只检查程序功能是否能按照规格说明书的规定正常使用，程序是否能适当地接收输入数据并产生正确的输出信息，程序运行过程中能否保持外部信息的完整性。黑盒测试又称为功能测试，包含等价类划分法、边界值法、错误推测法、因果图法等。（2）白盒测试法: 是把程序看成装在一个透明的白盒子里，测试者完全知道程序的结构和处理算法。这种方法按照程序内部的逻辑测试程序，检测程序中的主要执行通路是否都能按预定要求正确工作。白盒测试又称为结构测试，包含逻辑覆",
      ...
      },
      {
        ...
        "options": [],
        "answer": "软件工程就是用科学的知识和技术原理来定义，开发，维护软件的一门学科。软件工程面临的问题：软件的费用，可靠性，可维护性，软件生产率和软件的重用。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "(1)采用自顶向下，逐步求精的程序设计方法。(2)使用三种基本控制结构构造程序，分别是顺序，选择和循环(3)采用主程序员组的组织形式。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "(1)建立明确的软件质量目标；(2)利用先进的软件开发技术和工具；(3)建立明确的质量保证工作；(4)选择可维护的程序设计语言；(5)改进程序文档。",
      ...
      },
      {
        ...
        "question": "简述文档在软件工程中的作用。",
        "options": [],
        "answer": "(1)提高软件开发过程的能见度；(2)提高开发效率；(3)作为开发人员阶段工作成果和结束标志；(4)记录开发过程的有关信息便于使用与维护；(5)提供软件运行、维护和培训有关资料；(6)便于用户了解软件功能、性能。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "软件开发技术的进步未能满足发展的要求。在软件开发中遇到的问题找不到解决的办法，问题积累起来，形态尖锐的矛盾，导致了软件危机。产生原因：⑴ 软件规模越来越大，结构越来越复杂。⑵ 软件开发管理困难而复杂。⑶ 软件包开发费用不断增加。⑷ 软件开发技术落后。⑸ 生产方式落后，仍采用手工方式。⑹ 开发工具落后，生产率提高缓慢。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "调试则是在进行了成功的测试之后才开始的工作。调试的目的是确定错误的原因和位置，并改正错误，因此调试也称为纠错(Debug)。调试的技术手段有简单的调试方法、归纳法、演绎法和回溯法等。",
      ...
      },
      {
        ...
        "options": [],
        "answer": "数据字典是关于数据的信息的集合，对数据流程图中的各个元素做完整的定义与说明，是数据流程图的补充工具。数据流图和数据字典共同构成系统的逻辑模型，没有数据字典数据流图就不严格，然而没有数据流图数据字典也难于发挥作用。 数据流图和对数据流图中每个元素的精确定义放在一起，才能共同构成系统的规格说明",
